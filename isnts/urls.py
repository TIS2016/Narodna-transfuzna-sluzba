...
urlpatterns = [
    ...
    url(r'^superuser/secret_key_change/$', views.superuser.secret_key_change),
    url(r'^superuser/employee_administration/$', views.superuser.employee_administration),
    url(r'^superuser/employee_administration/(?P<employee_id>[0-9]+)/$', views.superuser.employee_activation),
