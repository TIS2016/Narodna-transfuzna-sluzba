...
urlpatterns = [
    ...
    url(r'^donors/information/$', views.donor.information, name="donors"),
    ...
    url(r'^employees/logout/$', views.auth.employee_logout, name="employees"),
    ...
    url(r'^superuser/employee_administration/(?P<employee_id>[0-9]+)/$', views.superuser.employee_activation, name="superuser"),
